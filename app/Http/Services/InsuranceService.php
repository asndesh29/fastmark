...
class InsuranceService
{
    public function list(Request $request, $perPage = null)
    {
        ...
        $vehicles = Vehicle::with(['owner', 'vehicleCategory', 'vehicleType', 'insurance.latestRenewal', 'insurance.provider'])
    ...
    public function store(array $data)
    {
        ...
        try {
            ...
            $invoiceNumber = AppHelper::generateInvoiceNumber($renewalType->slug ?? 'insurance');
