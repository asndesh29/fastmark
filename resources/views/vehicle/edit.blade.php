        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Update Vehicle Info</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select vehicle-category" name="vehicle_category_id" required>
                                <option value="">Select Category</option>
                                @foreach($vehicle_categories as $vc)
                                    <option 
                                        value="{{ $vc->id }}" 
                                        data-type="{{ strtolower($vc->slug) }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const categorySelect = document.querySelector('.vehicle-category');
        const permitField = document.querySelector('.permit-field');
        const permitInput = permitField.querySelector('input');

        function togglePermitField() {
            ...
            if (type === 'private') {
                ...
                permitInput.value = '';
                permitInput.removeAttribute('required'); // JS front-end validation
            } else {
                permitField.style.display = 'block';
                permitInput.setAttribute('required', 'required'); // JS front-end validation
            }
        }

        // Run on page load and when category changes
        togglePermitField();
        categorySelect.addEventListener('change', togglePermitField);
    });
</script>
@endpush