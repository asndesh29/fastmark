                                        ...
                                        <div class="mt-4">
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" id="email" placeholder="Enter username" value="{{ old('email') }}" required autofocus>
                                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Fast Mark. Designed <i class="mdi mdi-heart text-danger"></i> by Yantra.
                            </p>
                        </div>
                    </div>
                </div>
