                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $renewal_type) }}" placeholder="Ex: Two Wheeler">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" max="99999.99" class="form-control @error('charge') is-invalid @enderror" id="charge" name="charge" value="{{ old('charge', $renewal_type) }}" placeholder="Ex: 300">
