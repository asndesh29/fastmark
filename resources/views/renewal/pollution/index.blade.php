            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Pollution</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Pollution Check List</h4>
                </div>
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle">
                                    ...
                                    <tbody id="renewalTableBody">
                                        @include('renewal.pollution.partials.table', ['renewal_lists' => $renewal_lists])
                                    </tbody>
                                </table>
                            </div>
                        </div>
            ...
            <form id="pollutionForm" method="POST" action="{{ route('admin.renewal.pollution.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Pollution Renewal</h5>
