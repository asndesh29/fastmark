...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Check Pass</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ route('admin.renewal.checkpass.update', $renewal->id) }}" method="POST">
                @csrf
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Check Pass Detail - {{ $renewal->vehicle->registration_no ?? 'N/A' }}</h4>
                    </div>
                    <!-- end card header -->
