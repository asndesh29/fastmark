        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Bluebook List</h4>
                </div>
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle">
                                    ...
                                    <tbody id="renewalTableBody">
                                        @include('renewal.bluebook.partials.table', ['renewal_lists' => $renewal_lists])
                                    </tbody>
                                </table>
                            </div>
                        </div>
            ...
            <form id="bluebookForm" method="POST" action="{{ route('admin.renewal.bluebook.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Update Bluebook Renewal</h5>
